...
func _process(_delta): # redo as groups
	$min/range.shape.radius = clamp(cal_min(parent.Data.Upgrades.MinRange, parent.Data.Upgrades.MaxRange),0,parent.Data.Upgrades.MaxRange)
